...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.angryNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.angryNumber.setGeometry(QtCore.QRect(740, 100, 61, 23))
        self.angryNumber.setDigitCount(5)
        self.angryNumber.setMode(QtWidgets.QLCDNumber.Mode.Dec)
        self.angryNumber.setSegmentStyle(QtWidgets.QLCDNumber.SegmentStyle.Filled)
        self.angryNumber.setObjectName("angryNumber")
        self.disgustNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.disgustNumber.setGeometry(QtCore.QRect(740, 152, 61, 23))
        self.disgustNumber.setObjectName("disgustNumber")
        self.fearNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.fearNumber.setGeometry(QtCore.QRect(740, 204, 61, 23))
        self.fearNumber.setObjectName("fearNumber")
        self.happyNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.happyNumber.setGeometry(QtCore.QRect(740, 255, 61, 23))
        self.happyNumber.setObjectName("happyNumber")
        ...
        self.neutralNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.neutralNumber.setGeometry(QtCore.QRect(740, 307, 61, 23))
        self.neutralNumber.setObjectName("neutralNumber")
        self.sadNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.sadNumber.setGeometry(QtCore.QRect(740, 359, 61, 23))
        self.sadNumber.setObjectName("sadNumber")
        self.surpriseNumber = QtWidgets.QLCDNumber(parent=Dialog)
        self.surpriseNumber.setGeometry(QtCore.QRect(740, 410, 61, 23))
        self.surpriseNumber.setObjectName("surpriseNumber")
